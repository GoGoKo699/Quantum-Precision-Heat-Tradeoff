...
Manuscript preparation is currently on hold. Researchers interested in collaborating are welcome to contact Ruge Lin at [gogoko699@gmail.com](mailto:gogoko699@gmail.com).

For an editorial correction, open an issue or pull request with the affected passage. For a scientific or implementation change, identify the precise claim, affected assumptions, and calculations. Keep mathematical derivations distinct from finite numerical evidence.

Run the tests, reproduction command, and repository checks before submitting changes. Preserve stable source identifiers, explicit error conventions, and complete energy accounting. Changes to the physical model or manuscript scope should be discussed with the maintainer rather than introduced as incidental refactoring.
